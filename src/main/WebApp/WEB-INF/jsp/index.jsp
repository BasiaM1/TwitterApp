...
<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="/"><img class="logoApp" src="resources/images/logoTweetApplication.png"></a>
        </div>
    ...
    <ul>
        ...
        <c:forEach items="${tweets}" var = "tweet">
            <li>
                ...
                <a href="/tweet/${tweet.id}/comment">Add a comment</a>
            </li>
            <br>
            <p>Comments of this tweet</p>
...
<footer class="container-fluid bg-4 text-center">
    <p>Tweeter Application For Everyone All Rights Reserved 2018</p>
</footer>
</body>
</html>